...
parser.add_argument('--model-path', type=str, default="/data/code/yolov5-test/mamba_m3fd.pt", help='Path to the model')  #cft results
#parser.add_argument('--model-path', type=str, default="/data/code/yolov5-test/mamba.pt", help='Path to the model')  #mamba results
parser.add_argument('--img-path', type=str, default="/data/datasets/M3FD/RGB/train/images/03186.png", help='input image path')
parser.add_argument('--img-path2', type=str, default="/data/datasets/M3FD/ir/train/images/03186.png", help='input image path')
...
parser.add_argument('--output-dir', type=str, default='runs/m3fd', help='output dir')
