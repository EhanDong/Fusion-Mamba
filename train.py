...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default="/data2/code/yolov5-test/models/transformer/yolov5l-fusion-v8.yaml", help='model.yaml path')
    parser.add_argument('--data', type=str, default="/data2/code/yolov5-modify/visdrone.yaml", help='data.yaml path')
    parser.add_argument('--hyp', type=str, default="/data2/code/yolov5-test/data/hyp.scratch.yaml", help='hyperparameters path')
